...
private:
	void balance(Element* Root)
	{
		...
		//Ôóíêöèÿ abs() âîçâðàùàåò àáñîëþòíîå çíà÷åíè - ìîäóëü ÷èñëà. 
	...
	void erase(int Data, Element*& Root)
	{
		...
		if (Data == Root->Data)
		{
			if (Root->pLeft == Root->pRight)	//Ïðîâåðÿì, ÿâëÿåòñÿ ëè óäàëÿåìûé ýëåìåíò ëèñòêîì
			{
				//È åñëè ýëåìåíò - ëèñòîê (ÍÅ èìååò ïîòîìêîâ), óäàëÿåì åãî èç ïàìÿòè
				delete Root;
				Root = nullptr;
			}
			else
